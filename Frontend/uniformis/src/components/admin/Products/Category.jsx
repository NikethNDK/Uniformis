              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {categories.map((cat) => (
                  <tr key={cat.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <span className={`px-2 py-1 rounded-full text-xs ${cat.is_active ? "bg-green-200 text-green-800" : "bg-red-200 text-red-800"}`}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <button
                        ...
                        className={`mr-2 text-2xl ${cat.is_active ? "text-green-500" : "text-gray-400"}`}
                      >
